...
[![Build Status](https://travis-ci.org/lovepoem/example-java-maven.svg?branch=master)](https://travis-ci.org/lovepoem/example-java-maven)
[![codecov](https://codecov.io/gh/lovepoem/example-java-maven/branch/master/graph/badge.svg)](https://codecov.io/gh/lovepoem/example-java-maven)
